...
class ActionSelect(discord.ui.Select):
    def __init__(self, actor, action_label):
        ...
        targets = [p for p in game.alive_players if p != actor]
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(f"{target.display_name} を{self.action_label}対象にしました。", ephemeral=True)
