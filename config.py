...
class WerewolfGame:
    ...
    def check_victory(self):
        ...
        if sk_count > 0 and len(self.alive_players) <= 2: return "第三陣営の勝利"
        if wolf_count >= (human_count + sk_count): return "人狼陣営の勝利"
        if "人狼" not in alive_role_names and "シリアルキラー" not in alive_role_names: return "村人陣営の勝利"
        return None
